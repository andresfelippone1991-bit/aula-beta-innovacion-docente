        ...
        <div className="bg-[#0b1d33] rounded-[2rem] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 border border-slate-800">
          ...
          <div className="shrink-0">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-xl font-bold text-lg transition-all shadow-xl shadow-blue-500/20 active:scale-95 whitespace-nowrap"
            >
              AGENDAR CONSULTORÍA
            </button>
          </div>
